		...
		return &http.Response{
			...
			Body: io.NopCloser(
				bytes.NewBufferString(
					`{"isPassCodeEnabled":true,"locale":"es_ES","redirectUrl":"https://trader.degiro.nl/trader/","sessionId":"FE1544EE1A2905C0954F71F863DA7EC2.prod11","status":0,"statusText":"success"}`,
				),
			),
